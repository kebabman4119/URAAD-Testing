...
var EPrice = 0.23; //As of 2021 October in Amherst, MA https://www.maenergyratings.com/electricity-rates/massachusetts/amherst
var creditVal = 40.44; //From https://www.spglobal.com/marketintelligence/en/news-insights/blog/infographic-q421-us-power-forecast
...
var OMCosts = 1850000; //Taken as linear relationship from CDM Smith study, their O&M was $1855000 for a 2382.94 L reactor, This is likely not true and NEEDs to be corrected
...
function updateVal() {
	...
	reactorVol = (feedVol/.1)*21; //Reactor volume in L
	totalCC = (3000*(reactorVol/90)**0.53)*(777/320)*(1*1.58+2.5); //Convert to gallons GET RID OF CAPITAL COST INPUT, Derived from https://link.springer.com/content/pdf/bbm%3A978-94-011-6544-0%2F1.pdf
